...
def launch():
    ...
    server.cmd("export PYTHONPATH=$PYTHONPATH:/root/aioquic-360-video-streaming/src")
    ...
    client.cmd("export PYTHONPATH=$PYTHONPATH:/root/aioquic-360-video-streaming/src")
